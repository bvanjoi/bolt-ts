...
as_node!(
    ...
    (ParamDecl, &'cx ast::ParamDecl<'cx>, as_param_decl, is_param_decl),
    ...
    (ClassDecl, &'cx ast::ClassDecl<'cx>, as_class_decl, is_class_decl),
    (BlockStmt, &'cx ast::BlockStmt<'cx>, as_block_stmt, is_block_stmt),
    ...
    (ArrayLit, &'cx ast::ArrayLit<'cx>, as_array_lit, is_array_lit),
    (Ident, &'cx ast::Ident, as_ident, is_ident),
    (OmitExpr, &'cx ast::OmitExpr, as_omit_expr, is_omit_expr),
    (ParenExpr, &'cx ast::ParenExpr<'cx>, as_paren_expr, is_paren_expr),
    (CondExpr, &'cx ast::CondExpr<'cx>, as_cond_expr, is_cond_expr),
    (ObjectMemberField, &'cx ast::ObjectMemberField<'cx>, as_object_member_field, is_object_member_field),
    (ObjectLit, &'cx ast::ObjectLit<'cx>, as_object_lit, is_object_lit),
    (CallExpr, &'cx ast::CallExpr<'cx>, as_call_expr, is_call_expr),
    (FnExpr, &'cx ast::FnExpr<'cx>, as_fn_expr, is_fn_expr),
    (NewExpr, &'cx ast::NewExpr<'cx>, as_new_expr, is_new_expr),
    (AssignExpr, &'cx ast::AssignExpr<'cx>, as_assign_expr, is_assign_expr),
    ...
    (ClassPropEle, &'cx ast::ClassPropEle<'cx>, as_class_prop_ele, is_class_prop_ele),
    (ClassMethodEle, &'cx ast::ClassMethodEle<'cx>, as_class_method_ele, is_class_method_ele),
    (ArrowFnExpr, &'cx ast::ArrowFnExpr<'cx>, as_arrow_fn_expr, is_arrow_fn_expr),
    (PrefixUnaryExpr, &'cx ast::PrefixUnaryExpr<'cx>, as_prefix_unary_expr, is_prefix_unary_expr),
    (ClassExpr, &'cx ast::ClassExpr<'cx>, as_class_expr, is_class_expr),
    (ClassExtendsClause, &'cx ast::ClassExtendsClause<'cx>, as_class_extends_clause, is_class_extends_clause),
    (ImplementsClause, &'cx ast::ImplementsClause<'cx>, as_implements_clause, is_implements_clause),
    (InterfaceExtendsClause, &'cx ast::InterfaceExtendsClause<'cx>, as_interface_extends_clause, is_interface_extends_clause),
    (IndexSigDecl, &'cx ast::IndexSigDecl<'cx>, as_index_sig_decl, is_index_sig_decl),
    (PropAccessExpr, &'cx ast::PropAccessExpr<'cx>, as_prop_access_expr, is_prop_access_expr),
    (ClassCtor, &'cx ast::ClassCtor<'cx>, as_class_ctor, is_class_ctor),
    (GetterDecl, &'cx ast::GetterDecl<'cx>, as_getter_decl, is_getter_decl),
    (SetterDecl, &'cx ast::SetterDecl<'cx>, as_setter_decl, is_setter_decl),
    (CallSigDecl, &'cx ast::CallSigDecl<'cx>, as_call_sig_decl, is_call_sig_decl),
    (InterfaceDecl, &'cx ast::InterfaceDecl<'cx>, as_interface_decl, is_interface_decl),
    (PropSignature, &'cx ast::PropSignature<'cx>, as_prop_signature, is_prop_signature),
    (MethodSignature, &'cx ast::MethodSignature<'cx>, as_method_signature, is_method_signature),
    (ThisExpr, &'cx ast::ThisExpr, as_this_expr, is_this_expr),
    (TypeDecl, &'cx ast::TypeDecl<'cx>, as_type_decl, is_type_decl),
    (RestTy, &'cx ast::RestTy<'cx>, as_rest_ty, is_rest_ty),
    (TupleTy, &'cx ast::TupleTy<'cx>, as_tuple_ty, is_tuple_ty),
    (IndexedAccessTy, &'cx ast::IndexedAccessTy<'cx>, as_indexed_access_ty, is_indexed_access_ty),
