...
prefilled_atom_map!(
    init_atom_map,
    {
        ...
        IDENTIFIER: {
            ...
            IDENT_REGEXP_CLASS:                     ["RegExp", 98],
            IDENT_PROTOTYPE:                        ["prototype", 99],
            IDENT_EXTRACT:                          ["Extract", 100],
            IDENT_EVAL:                             ["eval", 101],
            IDENT_NON_NULLABLE:                     ["NonNullable", 102],
            IDENT_OMIT:                             ["Omit", 103],
            IDENT_AWAITED:                          ["Awaited", 104],
            INTRINSIC_TYPE_UPPERCASE:               ["Uppercase", 105],
            INTRINSIC_TYPE_LOWERCASE:               ["Lowercase", 106],
            INTRINSIC_TYPE_CAPITALIZE:              ["Capitalize", 107],
            INTRINSIC_TYPE_UNCAPITALIZE:            ["Uncapitalize", 108],
            INTRINSIC_TYPE_NOINFER:                 ["NoInfer", 109],
            IDENT_PUSH:                             ["push", 110],
            IDENT_UNSHIFT:                          ["unshift", 111],
            IDENT_OPTIONAL:                         ["optional", 112],
            IDENT_THEN:                             ["then", 113],
            IDENT_PROMISE:                          ["Promise", 114],
            IDENT_PROMISE_LIKE:                     ["PromiseLike", 115],
            IDENT_ITERATOR:                         ["iterator", 116],
            IDENT_ITERATOR_CLASS:                   ["Iterator", 117],
            IDENT_ASYNC_ITERATOR:                   ["asyncIterator", 118],
            IDENT_ASYNC_ITERATOR_CLASS:             ["AsyncIterator", 119],
            IDENT_ASYNC_ITERABLE:                   ["AsyncIterable", 120],
            IDENT_ASYNC_ITERABLE_ITERATOR:          ["AsyncIterableIterator", 121],
            IDENT_READABLE_STREAM_ASYNC_ITERATOR:   ["ReadableStreamAsyncIterator", 122],
            IDENT_ASYNC_ITERATOR_OBJECT:            ["AsyncIteratorObject", 123],
            IDENT_ITERABLE:                         ["Iterable", 124],
            IDENT_ITERABLE_ITERATOR:                ["IterableIterator", 125],
            IDENT_ITERATOR_OBJECT:                  ["IteratorObject", 126],
            IDENT_GENERATOR:                        ["Generator", 127],
            IDENT_ASYNC_GENERATOR:                  ["AsyncGenerator", 128],
            IDENT_ARRAY_ITERATOR:                   ["ArrayIterator", 129],
            IDENT_MAP_ITERATOR:                     ["MapIterator", 130],
            IDENT_SET_ITERATOR:                     ["SetIterator", 131],
            IDENT_STRING_ITERATOR:                  ["StringIterator", 132],
            IDENT_NEXT:                             ["next", 133],
            IDENT_ITERATOR_YIELD_RESULT:            ["IteratorYieldResult", 134],
            IDENT_ITERATOR_RETURN_RESULT:           ["IteratorReturnResult", 135],
            IDENT_DONE:                             ["done", 136],
            IDENT_VALUE:                            ["value", 137],
            IDENT_REQUIRE:                          ["require", 138],
            IDENT_RECORD:                           ["Record", 139],
            IDENT_NAN:                              ["NaN", 140]
        },
        DIRECTIVES: {
            DIRECTIVE_USE_STRICT:                   ["use strict", 141]
        },
        SPECIAL_IDENTIFIER: {
            SPECIAL_IDENT_ERROR:                    ["<error>", 142]
        },
        NUMBER: {
            NUMBER_ZERO:                            ["0", 143],
        },
