...
impl<'cx> MergeSymbol<'cx> for MergeModuleAugmentation<'_, 'cx> {
    fn get_symbols(&self, module: bolt_ts_span::ModuleID) -> &bolt_ts_binder::Symbols {
        &self.bind_list[module.as_usize()].symbols
    }
    fn get_mut_symbols(&mut self, module: bolt_ts_span::ModuleID) -> &mut bolt_ts_binder::Symbols {
