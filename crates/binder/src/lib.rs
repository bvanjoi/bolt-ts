...
pub struct Binder {
    pub bind_results: Vec<ResolveResult>,
}
...
struct BinderState<'cx, 'atoms, 'parser> {
    ...
    _emit_flags: bolt_ts_ast::NodeFlags,
    ...
    _report_unreachable_flow_node: FlowID,
...
impl<'cx, 'atoms, 'parser> BinderState<'cx, 'atoms, 'parser> {
    fn new(
        ...
        BinderState {
            ...
            _emit_flags: bolt_ts_ast::NodeFlags::empty(),
            parent: None,
            current_flow: None,
            ...
            _report_unreachable_flow_node: report_unreachable_flow_node,
...
pub struct BinderResult<'cx> {
    ...
    pub parent_map: ParentMap,
    pub final_res: FxHashMap<ast::NodeID, SymbolID>,
    pub flow_nodes: FlowNodes<'cx>,
    pub flow_in_nodes: FlowInNodes,
}
