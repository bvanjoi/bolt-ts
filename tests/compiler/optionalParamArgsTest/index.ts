// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/optionalParamArgsTest.ts`, Apache-2.0 License
...
class C1 {
    ...
    //~^ ERROR: Operator '+' cannot be applied to types 'number' and 'undefined | number'.
