// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/capturedParametersInInitializers1.ts`, Apache-2.0 License
...
function foo4(y = {z}, z = 1) {
  //~^ ERROR: Parameter 'y' cannot reference identifier 'z' declared after it.
}
