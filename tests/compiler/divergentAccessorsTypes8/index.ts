// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/divergentAccessorsTypes8.ts`, Apache-2.0 License
...
i2['prop1'] = 42;
//~^ ERROR: Type 'number' is not assignable to type '"hello"'.
i2['prop1'] = "hello";
