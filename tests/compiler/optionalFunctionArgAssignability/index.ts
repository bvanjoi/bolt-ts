...
//~^ ERROR: Type '(onFulFill: undefined | ((value: number) => U), onReject: undefined | ((reason: any) => U)) => Promise<U>' is not assignable to type '(onFulfill: undefined | ((value: string) => U), onReject: undefined | ((reason: any) => U)) => Promise<U>'.
