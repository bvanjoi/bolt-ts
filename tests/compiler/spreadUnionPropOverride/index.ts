// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/spreadUnionPropOverride.ts`, Apache-2.0 License
...
const obj2 = {
    x: 1,
    //~^ ERROR: 'x' is specified more than once, so this usage will be overwritten.
...
const obj4 = {
    a: "test",
    //~^ ERROR: 'a' is specified more than once, so this usage will be overwritten.
    ...partial,
