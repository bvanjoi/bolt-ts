// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/controlFlowAliasedDiscriminants.ts`, Apache-2.0 License
...

{
    ...
    if (areSuccess) {
        ...
        //~^ ERROR: 'data1' is possibly 'undefined'.
        data2.toExponential();  // should error
        //~^ ERROR: 'data2' is possibly 'undefined'.
        data3.toExponential();  // should ok
    }
}
...

{
    ...
    if (arrayAllSuccess) {
        ...
        //~^ ERROR: 'bar2' is possibly 'undefined'.
        bar3.toExponential();   // should error
        //~^ ERROR: 'bar3' is possibly 'undefined'.
    }
}
...

{
    ...
    if (type === 'string') {
        ...
        //~^ ERROR: Type 'number | string' does not satisfy the expected type 'string'.
    }
    if (resp.type === 'string') {
