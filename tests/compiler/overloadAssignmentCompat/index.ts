// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/overloadAssignmentCompat.ts`, Apache-2.0 License
...
function foo():number;  //~ERROR: This overload signature is not compatible with its implementation signature.
