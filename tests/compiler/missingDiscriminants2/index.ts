// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/missingDiscriminants2.ts`, Apache-2.0 License
...
//~^ ERROR: Object literal may only specify known properties, and 'subkind' does not exist in type '{ kind: "b"; }'.
