...
//~^ ERROR: Type 'Foo.A' is not assignable to type 'false | true | Foo.A | Foo.B'.
const e2: X.Foo.A | X.Foo.B | boolean = Z.Foo.A; // still not legal
//~^ ERROR: Type 'Foo.A' is not assignable to type 'false | true | Foo.A | Foo.B'.
const e3: X.Foo.B | boolean = Z.Foo.A; // not legal
//~^ ERROR: Type 'Foo.A' is not assignable to type 'false | true | Foo.B'.
...
//~^ ERROR: Type 'Foo.A' is not assignable to type 'false | true | Foo.A'.
