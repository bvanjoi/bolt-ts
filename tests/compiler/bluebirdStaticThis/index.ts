// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/bluebirdStaticThis.ts`, Apache-2.0 License
...
export declare class Promise<R> implements Promise.Thenable<R> {
  //~^ ERROR: Property 'then' is missing.
    ...
    //~^ ERROR: Namespace 'Promise' has no exported member 'Resolver'.
    ...
    //~^ ERROR: Namespace 'Promise' has no exported member 'Inspection'.
