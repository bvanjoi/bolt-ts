// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/genericArgumentCallSigAssignmentCompat.ts`, Apache-2.0 License
...
//~^ ERROR: Argument of type '<T>(value: T) => T' is not assignable to parameter of type 'undefined | Underscore.Iterator<null | false | true | number | string, boolean>'.
