// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/derivedInterfaceCallSignature.ts`, Apache-2.0 License
...
interface D3SvgArea extends D3SvgPath {
  //~^ ERROR: Interface 'D3SvgArea' incorrectly extends interface 'D3SvgPath'.
