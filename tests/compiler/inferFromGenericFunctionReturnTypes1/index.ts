// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/inferFromGenericFunctionReturnTypes1.ts`, Apache-2.0 License
...
class SetOf<A> {
  _store: A[];
  //~^ ERROR: Property '_store' has no initializer and is not definitely assigned in the constructor.
