// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/spreadsAndContextualTupleTypes.ts`, Apache-2.0 License
...
const t2 = ['x', 'y'] as const;
fx1([...t2, 'a']);
//~^ ERROR: Argument of type '["x", "y", "a"]' is not assignable to parameter of type '[string, string, string, "a" | "b"]'.
fx2([...t2, 'a']);