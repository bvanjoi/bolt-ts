// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/constantEnumAssert.ts`, Apache-2.0 License
...
//~^ ERROR: A 'const' assertion can only be applied to references to enum members, or string, number, boolean, array, or object literals.
