// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/unusedLocalsOnFunctionDeclarationWithinFunctionExpression2.ts`, Apache-2.0 License
