// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/privacyGloVar.ts`, Apache-2.0 License
...
namespace m1 {
    ...
    export class C3_public {
        ...
        //~^ ERROR: Property 'C3_v1_private' has no initializer and is not definitely assigned in the constructor.
        public C3_v2_public: C1_public;
        //~^ ERROR: Property 'C3_v2_public' has no initializer and is not definitely assigned in the constructor.
        private C3_v3_private: C2_private;
        //~^ ERROR: Property 'C3_v3_private' has no initializer and is not definitely assigned in the constructor.
        public C3_v4_public: C2_private; // error
        //~^ ERROR: Property 'C3_v4_public' has no initializer and is not definitely assigned in the constructor.
    ...
    class C4_public {
        ...
        //~^ ERROR: Property 'C4_v1_private' has no initializer and is not definitely assigned in the constructor.
        public C4_v2_public: C1_public;
        //~^ ERROR: Property 'C4_v2_public' has no initializer and is not definitely assigned in the constructor.
        private C4_v3_private: C2_private;
        //~^ ERROR: Property 'C4_v3_private' has no initializer and is not definitely assigned in the constructor.
        public C4_v4_public: C2_private;
        //~^ ERROR: Property 'C4_v4_public' has no initializer and is not definitely assigned in the constructor.
...
class glo_C3_public {
    ...
    //~^ ERROR: Property 'glo_C3_v1_private' has no initializer and is not definitely assigned in the constructor.
    public glo_C3_v2_public: glo_C1_public;
    //~^ ERROR: Property 'glo_C3_v2_public' has no initializer and is not definitely assigned in the constructor.
