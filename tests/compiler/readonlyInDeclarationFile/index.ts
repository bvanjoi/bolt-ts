// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/readonlyInDeclarationFile.ts`, Apache-2.0 License
...
class C {
    ...
    //~^ ERROR: Property 'a1' has no initializer and is not definitely assigned in the constructor.
    protected readonly a2: number;
    //~^ ERROR: Property 'a2' has no initializer and is not definitely assigned in the constructor.
    public readonly a3: number;
    //~^ ERROR: Property 'a3' has no initializer and is not definitely assigned in the constructor.
