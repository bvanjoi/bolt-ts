// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/narrowingMutualSubtypes.ts`, Apache-2.0 License
...
function f(a: Array<string> | string) {
  ...
  if (Array.isArray(a) && a.length)  {
    ...
    const b: 42 = a;
    //~^ ERROR: Type 'string | string[]' is not assignable to type '42'.
  }
}