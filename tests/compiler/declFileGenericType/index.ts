// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/declFileGenericType.ts`, Apache-2.0 License
...
export namespace C {
    ...
    //~^ ERROR: Type 'null' is not assignable to type 'C.A<C.B>'.
