// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/computedTypesKeyofNoIndexSignatureType.ts`, Apache-2.0 License
...
const a0: FooBarKey = "foo";
const a1: FooBarKey = "bar";
const a2: FooBarKey = "42";
