// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/typePartameterConstraintInstantiatedWithDefaultWhenCheckingDefault.ts`, Apache-2.0 License
...
class Identity<V> implements Settable<Identity<V>, V> {
    ...
    public set(value: V): Identity<V> {
        this.item = value;
        //~^ ERROR: Cannot assign to 'item' because it is a read-only property.
