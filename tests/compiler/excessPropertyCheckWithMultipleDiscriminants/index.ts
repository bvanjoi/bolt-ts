// From `github.com/microsoft/TypeScript/blob/v6.0.2/tests/cases/compiler/excessPropertyCheckWithMultipleDiscriminants.ts`, Apache-2.0 License
...
const foo: Primitive = {
    ...
    //~^ ERROR: Object literal may only specify known properties, and 'multipleOf' does not exist in type 'Float'.
    format: "what?"
}
...
const a: DisjointDiscriminants = {
    ...
    p2: false,
    p3: 42,
    //~^ ERROR: Object literal may only specify known properties, and 'p3' does not exist in type '{ p1: "left"; p2: boolean; }'.
    p4: "hello"
};
...
const b: DisjointDiscriminants = {
    ...
    p3: 42,
    p4: "hello"
    //~^ ERROR: Object literal may only specify known properties, and 'p4' does not exist in type '{ p1: "left"; p2: true; p3: number; } | { p1: "left"; p2: boolean; }'.
};
...
const c: DisjointDiscriminants = {
    ...
    p2: false,
    p3: 42,
    //~^ ERROR: Object literal may only specify known properties, and 'p3' does not exist in type '{ p1: "right"; p2: false; p4: string; }'.
    p4: "hello"
};
...
const c1: CommonWithOverlappingOptionals = {
    ...
    a: 1,
    b: 1  // excess property
    //~^ ERROR: Object literal may only specify known properties, and 'b' does not exist in type 'Common | Common & A'.
}
...
const c2: CommonWithDisjointOverlappingOptionals = {
    ...
    a: 1,
    b: 1  // excess property
    //~^ ERROR: Object literal may only specify known properties, and 'b' does not exist in type 'Common | A'.
}
...
const attributes: Attribute = {
    type: 'string',
    autoIncrement: true,
    //~^ ERROR: Object literal may only specify known properties, and 'autoIncrement' does not exist in type 'StringAttribute | OneToOneAttribute'.
    required: true,
};
...
const attributes2: Attribute2 = {
    type: 'string',
    autoIncrement: true,
    //~^ ERROR: Object literal may only specify known properties, and 'autoIncrement' does not exist in type 'StringAttribute'.
    required: true,
};
