// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/genericReduce.ts`, Apache-2.0 License
...
//~^ ERROR: Property 'x' does not exist on type 'number'.
