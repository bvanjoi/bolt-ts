// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/unspecializedConstraints.ts`, Apache-2.0 License
...
namespace ts {
    ...
    class Type extends Symbol {
        ...
        getProperty(index: number): Property {
            return undefined;
            //~^ ERROR: Type 'undefined' is not assignable to type 'Property'.
        }
        ...
        getSignature(index: number): Signature {
            return undefined;
            //~^ ERROR: Type 'undefined' is not assignable to type 'Signature'.
        }
    ...
    class Signature extends Symbol {
        constructor(public typeParameters: TypeParameter[], public parameters: Parameter[], public returnType: Type) {
            //~^ ERROR: Cannot find name 'TypeParameter'.
            super();
        }
