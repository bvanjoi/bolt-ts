// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/checkSuperCallBeforeThisAccess.ts`, Apache-2.0 License
...
class C1 extends A {
    constructor(n: number) {
        ...
        //~| ERROR: Class field 'x' defined by the parent class is not accessible in the child class via super.
        let a4 = () => this;
        let a5 = () => this.x;
        let a6 = () => super.x;
        //~^ ERROR: Class field 'x' defined by the parent class is not accessible in the child class via super.
