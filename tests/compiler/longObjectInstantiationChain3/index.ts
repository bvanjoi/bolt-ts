// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/longObjectInstantiationChain3.ts`, Apache-2.0 License
...
o1.p1;
o1.p51; // error
//~^ ERROR: Property 'p51' does not exist on type '{ p1: number; } & { p2: number; }'

o2.p1;
o2.p2;
o2.p3;
o2.p4; // error
//~^ ERROR: Property 'p4' does not exist on type 'Omit<{ p1: number; } & { p2: number; }, "p2"> & { p2: number; p3: number; }'.
