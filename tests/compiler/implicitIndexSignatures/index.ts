// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/implicitIndexSignatures.ts`, Apache-2.0 License
...
map = empty1;
map = empty2;
//~^ ERROR: Variable 'empty2' is used before being assigned.
map = names1;
map = names2;
//~^ ERROR: Variable 'names2' is used before being assigned.
