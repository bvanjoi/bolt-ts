// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/unusedLocalsOnFunctionExpressionWithinFunctionDeclaration1.ts`, Apache-2.0 License
