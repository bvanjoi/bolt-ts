// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/augmentedTypesModules.ts`, Apache-2.0 License
...
var m1a = 1; // error
//~^ ERROR: Duplicate identifier 'm1a'.

namespace m1b { export var y = 2; } // error
var m1b = 1; // error
//~^ ERROR: Duplicate identifier 'm1b'.
...
var m1d = 1; // error
//~^ ERROR: Duplicate identifier 'm1d'.
