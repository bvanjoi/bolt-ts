// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/optionalPropertiesTest.ts`, Apache-2.0 License
...
test10_1 = test10_2;
//~^ ERROR: Type 'i2' is not assignable to type 'i1'.