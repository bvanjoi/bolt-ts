// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/gettersAndSetters.ts`, Apache-2.0 License
...
var baz = c.Baz;
//~^ ERROR: Property 'Baz' does not exist on type 'C'.
c.Baz = "bazv";
//~^ ERROR: Property 'Baz' does not exist on type 'C'.
