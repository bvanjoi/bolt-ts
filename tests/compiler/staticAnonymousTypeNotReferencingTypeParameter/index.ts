// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/staticAnonymousTypeNotReferencingTypeParameter.ts`, Apache-2.0 License
...
namespace tessst {
    ...
    export function funkyFor<T, U>(array: T[], callback: (element: T, index: number) => U): U {
        ...
        return undefined;
        //~^ ERROR: Type 'undefined' is not assignable to type 'U'.
    }
}
interface Scanner {
...
class ListWrapper {
  ...
  static reversed<T>(dit: typeof ListWrapper, array: T[]): T[] {
    ...
    //~^ ERROR: Variable 'scanner' is used before being assigned.
