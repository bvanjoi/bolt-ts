var itemNumber = [0].findLast((item) => (item === 0));
var itemString = ['string'].findLast((item) => (item === 'string'));
...
var indexNumber = [0].findLastIndex((item) => (item === 0));
var indexString = ['string'].findLastIndex((item) => (item === 'string'));
