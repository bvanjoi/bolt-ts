// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/thislessFunctionsNotContextSensitive1.ts`, Apache-2.0 License
...
test55124({
  target: "$test6", // error
  //~^ ERROR:  Type '"$test6"' is not assignable to type 'undefined | "$test4" | "$test1" | "$test2" | "$test3" | "$test5"'.
  data1: {
    $test1: 111,
    $test2: null,
  },
