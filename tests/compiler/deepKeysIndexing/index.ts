// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/deepKeysIndexing.ts`, Apache-2.0 License
...
//~^ ERROR: Argument of type 'boolean' is not assignable to parameter of type '123'
