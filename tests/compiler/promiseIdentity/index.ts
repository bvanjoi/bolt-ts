// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/promiseIdentity.ts`, Apache-2.0 License
...
//~^ ERROR: Subsequent variable declarations must have the same type. Variable 'y' must be of type 'IPromise2<string, number>', but here has type 'Promise2<any, string>'.
