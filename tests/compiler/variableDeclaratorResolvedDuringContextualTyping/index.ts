// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/variableDeclaratorResolvedDuringContextualTyping.ts`, Apache-2.0 License
        ...
        return this.requestService.makeRequest({
            ...
            data: "someData"
                ...
                var result: IUploadResult = { // This should be error
                  //~^ ERROR: Cannot find name 'IUploadResult'.
                    stat: this.jsonToStat(newFilePath, "someString"), // _this needs to be emitted to the js file
                    //~^ ERROR: Property 'jsonToStat' does not exist on type 'FileService<FileService>'.
                    //~| ERROR: Cannot find name 'newFilePath'.
