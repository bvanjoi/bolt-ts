...
//~^ ERROR: Type '(val: any) => undefined | "1" | "2" | "3" | "4" | "5"' is not assignable to type '(arg: Values) => string'.
    switch (val) {
      case 1:
        return "1";
      case 2:
...
//~^ ERROR: Type '(val: Values) => undefined | "1" | "2" | "3" | "4" | "5"' is not assignable to type '(arg: Values) => string'.
    switch (val) {
      case 1:
        return "1";
      case 2:
