// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/narrowingOfQualifiedNames.ts`, Apache-2.0 License
...
function init2(foo: DeepOptional) {
    if (foo.a) {
        ...
        //~^ ERROR: Property 'c' does not exist on type 'undefined | { c: undefined | string; }'.
