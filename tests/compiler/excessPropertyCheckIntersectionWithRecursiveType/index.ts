// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/excessPropertyCheckIntersectionWithRecursiveType.ts`, Apache-2.0 License
  ...
  props: {
    l1: {
      props: {
        l2: { type: 'boolean' },
        invalid: false,
        //~^ ERROR: Object literal may only specify known properties, and 'invalid' does not exist in type '{ }'.
      },
    },
  },
}
  ...
  props: {
    l1: {
      props: {
        l2: { type: 'boolean' },
        invalid: false,
        //~^ ERROR: Object literal may only specify known properties, and 'invalid' does not exist in type 'Example<{ l2: boolean; }> & { }'.
      },
    },
  },
}
      ...
      children: [
        {
          name: "Grand son",
          children: [
            //~^ ERROR: Object literal may only specify known properties, and 'children' does not exist in type 'User'.
            {
              name: "123",
              children: [
                {
...
//~^ ERROR: Property 'children' does not exist on type 'User'.
