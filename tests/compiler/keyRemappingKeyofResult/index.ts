// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/keyRemappingKeyofResult.ts`, Apache-2.0 License
...
function g<T>() {
    ...
    x = "str";
    x = "whatever"; // error
    //~^ ERROR: Type 'string' is not assignable to type 'keyof Remapped'.
}
