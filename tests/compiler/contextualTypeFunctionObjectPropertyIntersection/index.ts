// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/contextualTypeFunctionObjectPropertyIntersection.ts`, Apache-2.0 License
...
createMachine2({
  ...
  on: {
    bar: (ev) => {
      //~^ ERROR: Object literal may only specify known properties, and 'bar' does not exist in type '{ } & { *: undefined | (Action<{ type: "FOO"; } | { type: "bar"; }>); }'.
