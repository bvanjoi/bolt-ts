// From `github.com/microsoft/TypeScript/blob/v6.0.3/tests/cases/compiler/inferentiallyTypingAnEmptyArray.ts`, Apache-2.0 License
...
foo([]).bar;
//~^ ERROR: Property 'bar' does not exist on type 'never'.